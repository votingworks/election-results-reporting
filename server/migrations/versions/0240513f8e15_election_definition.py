...
def upgrade():
    op.create_table(
        ...
        sa.UniqueConstraint(
            "election_id", "name", name=op.f("precinct_election_id_name_key")
        ),
    )
    op.create_table(
        "contest",
        ...
        sa.UniqueConstraint(
            "election_id", "name", name=op.f("contest_election_id_name_key")
        ),
    )
    op.create_table(
        "candidate",
        ...
        sa.UniqueConstraint(
            "contest_id", "name", name=op.f("candidate_contest_id_name_key")
        ),
    )
